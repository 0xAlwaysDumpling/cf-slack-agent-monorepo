/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3ca0accf7fac874d97da143934677399)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CF_ACCOUNT_ID: string;
		CF_GATEWAY: string;
		PROMPTS_BUCKET?: R2Bucket;
		MESSAGES_BUCKET?: R2Bucket;
		JOBS_DB?: D1Database;
		MyAgent?: DurableObjectNamespace<import("./src/index").MyAgent>;
		DEV_AGENT?: Fetcher /* cf-dev-agent */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_SIGNING_SECRET" | "CF_AIG_TOKEN" | "CF_ACCOUNT_ID" | "CF_GATEWAY">> {}
}
